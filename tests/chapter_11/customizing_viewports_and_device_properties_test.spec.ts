...
test('Custom mobile emulation test', async ({ browser }) => {
    const context = await browser.newContext({
        ...
        deviceScaleFactor: 2,
        isMobile: true,
        userAgent: 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_5 like Mac OS X)AppleWebKit/ 605.1.15(KHTML, like Gecko) Version / 13.1.1 Mobile / 15E148Safari / 604.1',
    });
    ...
    await page.screenshot({ path: 'test-results/custom-mobile-emulation.png' });
